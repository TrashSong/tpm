    ...
    <form method="POST" action="/projects/{{ $project->id }}">
          ...
          <div class="border-b border-gray-900/10 pb-12">
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <div class="col-span-full">
                <label for="shortDescription" class="block text-sm/6 font-medium text-gray-900">Short Description</label>
                <div class="mt-2">
                  <textarea 
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            ...
            <div class="flex items-center gap-x-6">
                <a href="/projects/{{ $project->id }}" type="button" class="text-sm/6 font-semibold text-gray-900">Cancel</button>
                <button type="submit" 
      ...
      <form method="POST" action="/projects/{{ $project->id }}" id="delete-form" class="hidden">
        @csrf
        @method('DELETE')
      </form>
</x-layout>